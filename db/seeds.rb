...
User.create(nick_name: "bryamradmin", password: "ycdvauai", role: role_admin)
User.create(nick_name: "bryamrsupervisor", password: "ycdvauai", role: role_supervisor)
User.create(nick_name: "bryamrcustomer", password: "ycdvauai", role: role_customer)
...
actividad = ActivityType.create(name: "Activación");
campana = ActivityType.create(name: "Campaña");
evento = ActivityType.create(name: "Evento");

actividad.activity_modes.create(name: "Imagen")
actividad.activity_modes.create(name: "Impulsación")
actividad.activity_modes.create(name: "Degustación")
actividad.activity_modes.create(name: "Sampling")
actividad.activity_modes.create(name: "Volanteo")

campana.activity_modes.create(name: "Volanteo")
campana.activity_modes.create(name: "Comunicación")
campana.activity_modes.create(name: "Degustación")
campana.activity_modes.create(name: "Impulsación")
campana.activity_modes.create(name: "Sampling")


# Departments
amazonas = Department.create(name: "Amazonas")
anchas = Department.create(name: "Áncash")
apurimac = Department.create(name: "Apurímac")
arequipa = Department.create(name: "Arequipa")
ayacucho = Department.create(name: "Ayacucho")
cajamarca = Department.create(name: "Cajamarca")
callao = Department.create(name: "Callao")
cusco = Department.create(name: "Cusco")
huancavelica = Department.create(name: "Huancavelica")
huanuco = Department.create(name: "Huánuco")
ica = Department.create(name: "Ica")
junin = Department.create(name: "Junín")
lalibertad = Department.create(name: "La Libertad")
lambayeque = Department.create(name: "Lambayeque")
lima = Department.create(name: "Lima")
loreto = Department.create(name: "Loreto")
madrededios = Department.create(name: "Madre de Dios")
moquegua = Department.create(name: "Moquegua")
pasco = Department.create(name: "Pasco")
piura = Department.create(name: "Piura")
puno = Department.create(name: "Puno")
sanmartin = Department.create(name: "San Martín")
tacna = Department.create(name: "Tacna")
tumbes = Department.create(name: "Tumbes")
ucayali = Department.create(name: "Ucayali")
